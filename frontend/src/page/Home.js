...
const achievementData = {
  0: {
    ...
    items: [
      ...
      { title: "화이트햇 2025 1위 국방부장관상", detail: "사이버보안 영재 발굴 및 사이버 전문인력 능력 향상을 목적을 국방부, 사이버작전사령부에서 주최한 대회입니다." },
      ...
      { title: "2026 HCTF 2위 한국정보처리학회장상", detail: "한양대학교 주최한 제 5회 한양 해킹방어대회입니다. " },
      { title: "BITSCTF 2026 1위", detail: "ITS Pilani Goa의 BITSkrieg가 Quark 축제의 일환으로 48시간 동안 전 세계 참가자 대상으로 진행한 CTF입니다." },
